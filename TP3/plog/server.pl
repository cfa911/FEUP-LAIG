...
% http://localhost:8081/valid_moves(Board, MoveNumber, MoveLetterConverted, MoveDirection)
% http://localhost:8081/valid_moves(Board,MoveNumber,MoveLetterConverted,MoveDirection)
% http://localhost:8081/valid_moves([[empty,empty],[orange_v,empty]],1,1,1)
% http://localhost:8081/game_over([[empty,empty],[orange_v,empty]],2)

% board:
% [[empty,empty],[orange_v,empty]],1,1,1
...
% Res = retorna o vencedor, none -> 0, brown -> 1, orange -> 2
parse_input(game_over(Board,Num), Res) :-
